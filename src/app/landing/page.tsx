        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            <div className="flex items-center">
              ...
              <div className="hidden md:ml-10 md:flex md:space-x-8">
                {['Features', 'Pricing', 'Testimonials'].map((item) => (
                  <Link key={item} href={`#${item.toLowerCase()}`} className="group text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium transition-colors duration-200">
                    {item}
            ...
            <div className="hidden md:flex md:items-center">
              <Link href="/login" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200">
                Login
              </Link>
              <Link href="/signup" className="ml-4 px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-700 rounded-md shadow-sm hover:shadow-lg transition-all duration-200 hover:translate-y-[-1px] focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                Sign Up Free
              </Link>
            </div>
          ...
          <div className="md:hidden bg-white/95 backdrop-blur-sm border-b border-indigo-100 py-2">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <div className="mt-4 flex flex-col space-y-2 px-3">
                <Link href="/login" className="w-full text-center px-4 py-2 text-base font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200 border border-gray-300 rounded-md">
                  Login
                </Link>
                <Link href="/signup" className="w-full text-center px-4 py-2 text-base font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-700 rounded-md shadow-sm">
                  Sign Up Free
                </Link>
              </div>
            </div>
