...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-blue-50 to-white flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <p className={`mt-2 text-center text-sm text-gray-600 transition-all duration-700 delay-100 max-w-sm mx-auto ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            Sign in to your account to continue building beautiful web experiences
          </p>
        </div>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow-2xl sm:rounded-xl sm:px-10 border border-gray-100 relative backdrop-blur-sm">
            ...
            <div className="space-y-1">
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className="appearance-none block w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-colors duration-200 text-gray-900"
                />
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center py-2.5 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transform hover:-translate-y-0.5"
                aria-label="Sign in with Google"
              >
                <svg className="h-5 w-5 text-[#4285F4]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
              ...
              >
                <svg className="h-5 w-5 text-[#1DA1F2]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              >
                <svg className="h-5 w-5 text-[#333]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
      ...
      {/* Add animation keyframes with enhanced animations */}
      <style jsx global>{`
        @keyframes blob {
          0% {
